...
const Meta = ({
  ...
  `,
  image: outsideImage = 'https://bookdriving.co.uk/logo.png',
  asPath = '/',
  author = 'Ahmed Ibrahim',
  keyword = 'Ahmed',
}: Props) => {
  const url = `https://bookdriving.co.uk${asPath}`
  const image = outsideImage
    ? `https://bookdriving.co.uk${outsideImage}`
    : `https://bookdriving.co.uk/logo.png`
  ...
  return {
    ...
    metadataBase: new URL('https://bookdriving.co.uk'),
    alternates: {
      canonical: url,
      languages: {
        'en-US': '/en-US',
    ...
    verification: {
      ...
      yahoo: 'yahoo',
      other: {
        me: ['info@bookdriving.co.uk', 'http://bookdriving.co.uk'],
      },
    },
  }
}
